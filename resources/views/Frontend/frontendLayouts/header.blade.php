...
<head>
    ...
    <!-- jquery-ui.css -->
    <link rel="stylesheet" href="{{ asset('Frontend assets/assets/css/jquery-ui.css') }}">
    <!-- metisMenu.min.css -->
    <link rel="stylesheet" href="{{ asset('Frontend assets/assets/css/metisMenu.min.css') }}">
    <!-- swiper.min.css -->
    <link rel="stylesheet" href="{{ asset('Frontend assets/assets/css/swiper.min.css') }}">
    <!-- style css -->
    ...
    <!-- modernizr css -->
    <script src="{{ asset('Frontend assets/assets/js/vendor/modernizr-2.8.3.min.js') }}"></script>
</head>
