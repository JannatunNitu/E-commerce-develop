                                            ...
                                            <tbody>
                                               @forelse ($categories as $key => $category)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $category->slug }}</td>
                                                        <td>
                                                            <a class="btn btn-danger btn-sm" href="{{ route('category.force-delete',$category->id)}}">Delete</a>
                                                            <a class="btn btn-primary btn-sm" href="{{ route('category.restore',$category->id)}}">Restore</a>   
                                                        </td>
                                                    </tr>
                                                    @empty                                 
                                                    <tr>
